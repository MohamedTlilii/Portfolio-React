          ...
          <div className="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="col-lg-4 col-md-6 portfolio-item isotope-item">
              ...
              <div className="portfolio-info">
                <h4>EcoRide</h4>
                <p>E-Commerce EcoRide Electric-Scooter</p>
                <a 
            ...
            <div className="col-lg-4 col-md-6 portfolio-item isotope-item">
              ...
              <div className="portfolio-info">
                <h4>LEDJO</h4>
                <p>Ledjo Professional Ambient Lighting</p>
                <a 
            ...
            <div className="col-lg-4 col-md-6 portfolio-item isotope-item">
              ...
              <div className="portfolio-info">
                <h4>YTS</h4>
                <p>YTS Movies Torrents website</p>
                <a 
            ...
            <div className="col-lg-4 col-md-6 portfolio-item isotope-item">
              ...
              <div className="portfolio-info">
                ...
                <p>Redesigneda modern, responsive website for Centre Descartes</p>
                <a 
             ...
             <div className="col-lg-4 col-md-6 portfolio-item isotope-item">
              ...
              <div className="portfolio-info">
                <h4>BEST-CAR</h4>
                <p>Admin dashboard for a car rental service</p>
                <a 
