        ...
        <div className="row gy-4">
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div className="service-item item-orange position-relative">
              ...
              <p>
                Building RESTful APIs with Node.js and Express.js. Integration with databases like MongoDB or
                PostgreSQL.
              </p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div className="service-item item-teal position-relative">
              ...
              <p>
                Developing complete web applications with both frontend and backend components. Demonstrating
                CRUD operations and authentication features.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
          <div class="service-item item-cyan position-relative">
            ...
            <p>Creation of responsive and dynamic websites using HTML, CSS, and JavaScript.
              Use of modern frameworks and libraries such as React, Angular.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
          <div class="service-item item-orange position-relative">
            ...
            <p>Building RESTful APIs with Node.js and Express.js.
              Integration with databases like MongoDB or PostgreSQL.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
          <div class="service-item item-teal position-relative">
            ...
            <p>Developing complete web applications with both frontend and backend components.
              Demonstrating CRUD operations and authentication features.</p>
          </div>
        </div>
